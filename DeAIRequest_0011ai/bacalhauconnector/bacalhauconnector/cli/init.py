from bacalhauconnector.ops.files import find_same_config, find_notebook, find_requirements
from bacalhauconnector.ops.requirements import get_package_info, render_package_info
from bacalhauconnector.ops.notebooks import get_code, read_notebook
from bacalhauconnector.ops.code import get_imported_modules, remove_magic_lines
from bacalhauconnector.data.config import SameValidator, name_schema, image_schema
...
def _get_api_version():
    return "bacalhauconnector.bacalhau/v001"
